...
namespace SessionAsp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult user_order(SigninModel obj)
        {
            if (HttpContext.Session.GetInt32("Id") == null)
            {
                RedirectToAction("Login");
        ...
        public IActionResult Menu(SigninModel obj)
        {
            if (HttpContext.Session.GetInt32("Id") == null)
            {
                RedirectToAction("Paypal");
            }
            //HttpContext.Session.Remove("TYId");

            return View();
        }
        public IActionResult Paypal(SigninModel obj)
        {
            if (HttpContext.Session.GetInt32("Id") == null)
            {
                RedirectToAction("Login");
